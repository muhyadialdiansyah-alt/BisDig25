// main.js - FIREBASE REAL-TIME VERSION
console.log('🚀 Loading main.js with Firebase support...');
...
async function initializeApp() {
  ...
  sections.forEach(id => {
    ...
    if (el) {
      el.innerHTML = '<p style="text-align:center;padding:20px;color:#64748b"><div class="spinner" style="border:3px solid rgba(255,255,255,0.1);border-top:3px solid #38bdf8;border-radius:50%;width:40px;height:40px;animation:spin 1s linear infinite;margin:0 auto 15px;"></div>Memuat data...</p>';
    }
  });
  
  // Strategi loading: Firebase first, then fallback to Data.js
  ...
  if (firebaseSuccess) {
    ...
    // Tunggu sebentar untuk Data.js dimuat
    setTimeout(() => {
...
console.log('✅ main.js loaded successfully with Firebase support');
